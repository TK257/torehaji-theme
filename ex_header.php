...
<?php wp_head();?>
  ...
  <header class="flexbox-align" id="header">
    <div class="nav-menu" id="nav-button">
      <i class="fa-solid fa-bars"></i><nav class="sp-nav">
<?php wp_nav_menu(); ?>
</nav>
    </div>
    <div><?php if (is_front_page() || is_home()): ?>  <h1><a href="/" class="logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo/site_logo_clear.png" alt="<?php bloginfo('name'); ?>"></a></h1><?php else: ?>  <div><a href="/" class="logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo/site_logo_clear.png" alt="<?php bloginfo('name'); ?>"></a></div><?php endif; ?></div><a class="padding-15" id="headerbtn" href="https://docs.google.com/forms/d/e/1FAIpQLScsA_er2rSFTm9mfAhMGSZhlvMvoE1RHUk_Y9bN6aMRn0gjNQ/viewform?usp=header" rel="nofollow">
      <button class="btn3 btn3-darkpink">お問合せ</button></a>
  </header><?php wp_nav_menu( array('container' => 'nav','container_class' => 'global-nav-wrapper','menu_class' => 'global-nav','items_wrap'      => '<ul class="%2$s">%3$s</ul>',) ); ?>
</html>
<!-- header end -->