    ...
    <div class="container"> 
      ...
      <div class="slideshow">
        ...
        <ul class="thumbnail" id="thumbnail">
          ...
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo02') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo03'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo03') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo04'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo04') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo05'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo05') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo06'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo06') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo07'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo07') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo08'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo08') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo09'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo09') . '.webp'; ?>"></li><?php endif; ?>
<?php if (!empty(get_field('gym_photo10'))) :?>
          <li><img src="<?php echo get_template_directory_uri() . '/assets/img/gym/anytime/shop/' . get_field('gym_photo10') . '.webp'; ?>"></li><?php endif; ?>
        </ul>
      </div>
