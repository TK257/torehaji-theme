...
function create_taxonomy_magazine_cat_blog_category()
{
  /**
   * カスタム分類名：マガジンのカテゴリ
   * スラッグ: magazine_cat
   * URLに使用するスラッグ: magazine-cat
   * 紐付く投稿タイプ：マガジン
   * 紐付く投稿タイプのスラッグ：magazine
   * カテゴリ形式か？：false
   */
  $taxonomyName = 'マガジンのカテゴリ';
  $taxonomySlug = 'magazine_cat';
  $taxonomySlugFront = 'magazine-cat';
...
add_action('init', 'create_taxonomy_magazine_cat_blog_category');
