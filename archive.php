...
<article>
  <section>
    <div class="container">
      ...
      <h1 class="eriah1"><?php echo esc_html(get_post_type_object(get_post_type())->label); ?>の記事一覧</h1>
      <div class="flexbox-sb"><?php if(have_posts()): ?>
<?php while(have_posts()): the_post(); ?>
        <div class="box-kiji"><a class="flexbox-sp" href="<?php the_permalink(); ?>">
            <h3 class="pcnone text-cut"><?php the_title(); ?></h3>
            <div class="thum border-radius"><?php if (has_post_thumbnail()): ?>
...
<?php endif; ?>
      ...
      <div class="margin-t20"><?php get_template_part('functions/pagination'); ?></div>
    </div>
  </section>
