  ...
  <section>
    <div class="container"> 
      <div class="main-waku">
        ...
        <h1 class="eriah1"><?php $tags = get_the_tags(); foreach ( $tags as $tag ) {echo $tag->name ;}?>のフィットネスジム・トレーニングジム</h1>
        <div class="seacheria">
          <p><i class="fa-solid fa-magnifying-glass"></i>検索条件</p>
          <div class="erianame"><?php $tags = get_the_tags(); foreach ( $tags as $tag ) {echo $tag->name ;}?></div>
...
<?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
        ...
        <div class="gymlist-waku">
          ...
          <div class="setsubi">
            <ul>
               <?php foreach(get_field('facility')as $data):?>
              <li><?php echo $data;?></li><?php endforeach;?>
            </ul>
          </div>
